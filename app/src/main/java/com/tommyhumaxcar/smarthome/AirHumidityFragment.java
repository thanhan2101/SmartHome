...
//    private String mParam2;
    ...
    private static AirHumidityFragment mInstance = null;

    private AirHumidityFragment() {}

    public static AirHumidityFragment getInstance() {
        if (mInstance == null) {
            mInstance = new AirHumidityFragment();
        }
        return mInstance;
    }
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_air_humidity, container, false);
    }
}